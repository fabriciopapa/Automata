    ...
    return {
        ...
        execute: function() {
            CommonService = (function (_super) {
                ...
                CommonService.prototype.pingServer = function (input) {
                    var parameters = new entities_module_1.Dictionary();
                    parameters.add("input", input);
                    var response = this.executeGet("Common", "PingServer", parameters).map(this.mapPingServerResponse.bind(this));
                    return response;
                };
                CommonService.prototype.mapPingServerResponse = function (info) {
                    var result = info;
                    return result;
                };
